...
public class BaseTile : GameBoardTile
{
    ...
    public override void InitMovementPattern()
    {
        ...
        if (straight)
        {
            movePattern = new StraightMovement(end, centerPos, Game.BOARD.GetTileLengths().x / 2.0f, 0.03f);
        }
        else
        {
            movePattern = new TurningMovement(centerPos, Game.BOARD.GetTileLengths().x / 2.0f, start, end, 0.03f);
        }
    }
